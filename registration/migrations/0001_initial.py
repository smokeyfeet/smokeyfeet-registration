# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2015-12-30 20:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('competitions', models.ManyToManyField(to='registration.CompetitionType')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='registration.VolunteerType'),
        ),
        migrations.AddField(
